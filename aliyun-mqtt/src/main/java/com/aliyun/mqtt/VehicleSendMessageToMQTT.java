 ...
 * @author : huagang
 * @version : 1.0
 * @title : com.aliyun.mqtt.MQ4IoTSendMessageToMQ4IoTUseSignatureMode
 * @description : TODO
 * @since : 2025/9/3
 */
public class VehicleSendMessageToMQTT {
    public static void main(String[] args) throws Exception {
         ...
         */
        String instanceId = "post-cn-1wy4erjqd01";
        /**
         * 接入点地址，购买 MQ4IOT 实例，且配置完成后即可获取，接入点地址必须填写分配的域名，不得使用 IP 地址直接连接，否则可能会导致客户端异常。
         */
        String endPoint = "post-cn-1wy4erjqd01.mqtt.aliyuncs.com";
        /**
         ...
         */
        String clientId = "GID_TEST@@@TBOX_CONTROL";
        /**
         * MQ4IOT 消息的一级 topic，需要在控制台申请才能使用。
         * 如果使用了没有申请或者没有被授权的 topic 会导致鉴权失败，服务端会断开客户端连接。
         */
        final String parentTopic = "tbox";
        String msg = "{\"v\":\"1.0\",\"cid\":\"DEM43868234\",\"ts\":\"20250903173147390\",\"fn\":\"5010\",\"i18n\":" +
                "\"zh-cn\",\"data\":\"veniamnullaExcepteur¥MDL#dmelfddsfmfel=\"}";
        /**
        ...
        mqttClient.setCallback(new MqttCallbackExtended() {
            ...
            public void deliveryComplete(IMqttDeliveryToken iMqttDeliveryToken) {
                System.out.println("send msg succeed, topic : " + iMqttDeliveryToken.getTopics()[0]
                        + " , msg : " + msg);
            }
        });
