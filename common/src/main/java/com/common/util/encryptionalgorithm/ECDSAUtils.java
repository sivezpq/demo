...
public class ECDSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // String encryptedData = ECDSAUtils.encrypt(ECDSAUtils.publicKey, data);
        // System.out.println("加密后的数据: " + encryptedData);
        // String decryptedData = ECDSAUtils.decrypt(ECDSAUtils.privateKey, encryptedData);
        // System.out.println("解密后的数据: " + decryptedData);

        String signData = Base64.getEncoder().encodeToString(ECDSAUtils.sign(ECDSAUtils.privateKey, data.getBytes()));
        System.out.println("sign数据: " + signData);
        boolean result = ECDSAUtils.verify(ECDSAUtils.publicKey, data.getBytes(), Base64.getDecoder().decode(signData));
